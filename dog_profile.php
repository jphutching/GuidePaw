        ...
        <div class="card-body">
            ...
            <form method="post" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="breed" class="form-control breed-input" value="<?= e($dog['breed']) ?>" autocomplete="off" placeholder="Type 2+ letters or enter a custom breed/mix" <?= $canEdit ? '' : 'disabled' ?>>
