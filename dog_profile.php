        ...
        <form method="post" enctype="multipart/form-data" class="row g-3"><input type="hidden" name="csrf_token" value="<?= e($csrf) ?>"><input type="hidden" name="action" value="save_profile">
            ...
            <details class="col-12 card shadow-sm mb-0" id="public-qr-details">
                ...
                <div class="card-body pt-0">
                    ...
                    <?php if ($canEdit): ?><div class="col-12 handler-defaults mb-3"><div class="d-flex flex-column flex-md-row gap-2 justify-content-between align-items-md-center"><div><strong>Use your Handler Profile defaults</strong><div class="small text-muted">Copies your handler address parts, name, public phone/email, handler photo, backup contact, and public notes to this dog.</div></div><button type="submit" name="action" value="use_handler_defaults" class="btn btn-outline-primary">Use Handler Profile info</button></div></div><?php endif; ?>
                    <div class="row g-3">
