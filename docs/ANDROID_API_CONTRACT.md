...
### Dog access and invites

- `GET /api/dog_access.php`
- `POST /api/dog_access.php`
- Lists the selected dog's handlers, pending invites, and incoming transfers
- Supports invite, accept, decline, revoke, and ownership transfer actions from the Android app
...
- Health Connect snapshots can include steps, distance, calories burned, exercise minutes, sleep, heart-rate, and resting-heart-rate summaries for the active dog
- FitBark and other tracker imports can store rest, active, play minutes, and battery percentage as the first dedicated dog-tracker connector path
