        ...
        <?php if ($currentSetup): ?>
            <div class="grid mt-3">
                <div class="metric">
                    ...
                    <?php if (!empty($currentSetup['handler_wearable_pairing_mode'])): ?><div class="small mt-2">Connection: <?= h((string) $currentSetup['handler_wearable_pairing_mode']) ?></div><?php endif; ?>
                    <?php if (!empty($currentSetup['handler_wearable_data_focus'])): ?><div class="small mt-1">Tracks: <?= h((string) $currentSetup['handler_wearable_data_focus']) ?></div><?php endif; ?>
                </div>
                <div class="metric">
                    ...
                    <?php if (!empty($currentSetup['dog_tracker_pairing_mode'])): ?><div class="small mt-2">Connection: <?= h((string) $currentSetup['dog_tracker_pairing_mode']) ?></div><?php endif; ?>
                    <?php if (!empty($currentSetup['dog_tracker_data_focus'])): ?><div class="small mt-1">Tracks: <?= h((string) $currentSetup['dog_tracker_data_focus']) ?></div><?php endif; ?>
                </div>
                <div class="metric">
