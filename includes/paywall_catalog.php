...
function gpPaywallCatalogDefaultRows(?string $itemType = null): array
{
    $rows = [
        ...
        [
            'slug' => 'tactical_training',
            'item_type' => 'service',
            'label' => 'Tactical Training',
            'summary' => 'Application-only training access for verified working teams.',
            'included_text' => "Application review\nVerified team access\nTactical readiness path",
            'locked_text' => '',
            'billing_model' => 'application_only',
            'required_tier' => 'free',
            'scope' => 'user',
            'price_cents' => 0,
            'currency' => 'USD',
            'sort_order' => 55,
            'is_active' => 1,
            'notes' => 'Grant after review for verified operational teams only.',
        ],
        [
            'slug' => 'qr_tracking',
            'item_type' => 'service',
