...
function gpWearableNormalizeRecordInput(array $input, string $defaultSource = 'manual'): array
{
    ...
    return [
        ...
        'total_calories_burned' => gpWearableNumericValue($merged, ['total_calories_burned', 'totalCaloriesBurned', 'calories_burned', 'caloriesBurned'], true),
...
function gpWearableCatalogSeed(): array
{
    return [
        ...
        ['slug' => 'samsung-galaxy-watch-6-classic', 'device_type' => 'handler_wearable', 'label' => 'Samsung Galaxy Watch 6 Classic', 'vendor' => 'Samsung', 'pairing_mode' => 'Health Connect / Samsung Health', 'data_focus' => 'Steps, HR, sleep, body composition', 'notes' => 'Rotating bezel model — same Health Connect sync as Galaxy Watch series.', 'sort_order' => 31],
