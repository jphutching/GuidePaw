...
function getDogBreedsCatalog(): array
{
    $catalog = [
        ...
        'Standard Poodle' => [
            ...
            'aliases' => ['Poodle (Standard)', 'Poodle'],
        ],
        ...
        'Miniature Poodle' => [
            ...
            'aliases' => ['Poodle (Miniature)', 'Mini Poodle', 'Miniature Caniche'],
        ],
        'Toy Poodle' => [
            'group' => 'Toy',
            ...
            'aliases' => ['Poodle (Toy)', 'Toy Caniche'],
        ],
        'Bichon Frise' => [
            'group' => 'Non-Sporting',
        ...
        'English Toy Spaniel' => [
            'group' => 'Toy',
            'breed_family' => 'Spaniel Family',
            'size' => 'Toy',
            'weight_range' => '8-14 lbs',
            'coat_type' => 'Silky medium coat with feathering',
            'shedding' => 'Low to moderate',
            'exercise_level' => 'Low to moderate',
            'temperament' => 'Bright, loving, willing to please, and closely bonded',
            'traits' => 'Best suited for alert, response, psychiatric, hearing, and close-monitoring tasks rather than physical support',
            'notes' => 'In England this breed is called the King Charles Spaniel, not to be confused with the Cavalier King Charles Spaniel. Common service-work fit: medical alerts, psychiatric response, hearing alerts, grounding routines, interruption tasks, and travel-friendly public access. Watch points: fragility, barking, confidence in crowds, dental and knee health, house-training consistency, and safe handling around larger dogs.',
            'aliases' => ['King Charles Spaniel', 'King Charles'],
        ],
        'Cavalier King Charles Spaniel' => [
            'group' => 'Toy',
            'breed_family' => 'Spaniel Family',
            'size' => 'Small',
            'weight_range' => '13-18 lbs',
            'coat_type' => 'Silky medium coat',
            'shedding' => 'Moderate',
            'exercise_level' => 'Low to moderate',
            'temperament' => 'Affectionate, soft, friendly',
            'traits' => 'Portable, social, naturally people-focused',
            'notes' => 'A separate breed from the English Toy Spaniel / King Charles Spaniel. Lovely temperament for companionship and emotional grounding. Health screening is especially important in this breed.',
            'aliases' => ['Cavalier', 'Cavalier Spaniel', 'Cavalier King Charles'],
        ],
        'Papillon' => [
            'group' => 'Toy',
