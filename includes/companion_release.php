...
if (!function_exists('gpCompanionReleaseInfo')) {
    function gpCompanionReleaseInfo(): array
    {
        ...
        $versionName = trim((string) gpEnv('GUIDEPAW_COMPANION_VERSION_NAME', '0.060'));
        $versionCode = (int) gpEnv('GUIDEPAW_COMPANION_VERSION_CODE', '60');
        ...
        return [
            ...
            'release_notes' => 'Forgot Password and Feedback now work when logged out.',
