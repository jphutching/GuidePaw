...
if (!function_exists('gpCompanionReleaseInfo')) {
    ...
    {
        $versionName = trim((string) gpEnv('GUIDEPAW_COMPANION_VERSION_NAME', '0.022'));
        $versionCode = (int) gpEnv('GUIDEPAW_COMPANION_VERSION_CODE', '22');
        ...
        return [
            ...
            'release_notes' => 'GuidePawWebActivity ported to Compose — OnBackPressedCallback replaces deprecated onBackPressed. Full Compose codebase maintained.',
