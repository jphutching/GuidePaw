...
if (!function_exists('gpCompanionReleaseInfo')) {
    function gpCompanionReleaseInfo(): array
    {
        ...
        $versionName = trim((string) gpEnv('GUIDEPAW_COMPANION_VERSION_NAME', '0.056'));
        $versionCode = (int) gpEnv('GUIDEPAW_COMPANION_VERSION_CODE', '56');
        ...
        return [
            ...
            'release_notes' => 'Native QR Tracking section — scan history, total views, device breakdown, shareable public dog profile URL; new api/qr_tracking.php.',
