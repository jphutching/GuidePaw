...
if (!function_exists('gpCompanionReleaseInfo')) {
    ...
    {
        $versionName = trim((string) gpEnv('GUIDEPAW_COMPANION_VERSION_NAME', '0.036'));
        $versionCode = (int) gpEnv('GUIDEPAW_COMPANION_VERSION_CODE', '36');
        ...
        return [
            ...
            'release_notes' => 'Native Goal Builder screen — category-aware hints, draft preview, and Save Goal; no longer opens a WebView.',
