...
<style>
    ...
    .gp-menu-subgroup { border: 1px solid rgba(15,23,42,.08); border-radius: 16px; margin: 0 .85rem .9rem; background: #f8fafc; overflow: hidden; }
    .gp-menu-subgroup summary { cursor: pointer; list-style: none; padding: .8rem .95rem; font-weight: 850; color: #111827; display: flex; align-items: center; justify-content: space-between; gap: .75rem; }
    .gp-menu-subgroup summary::-webkit-details-marker { display: none; }
    .gp-menu-subgroup summary::after { content: '⌄'; color: #6b7280; font-size: 1.1rem; transition: transform .15s ease; flex: 0 0 auto; }
    .gp-menu-subgroup[open] summary::after { transform: rotate(180deg); }
    .gp-menu-subgroup .gp-menu-link-grid { padding-top: 0; }
    .gp-menu-subgroup .gp-menu-description { padding-bottom: .7rem; }
...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    <div class="gp-menu-header"><div class="gp-menu-title">GuidePaw Menu</div><button type="button" class="gp-menu-close" id="gpMenuClose">Close</button></div>
    <div class="gp-menu-root-actions"><a class="settings" href="settings.php"><span class="gp-menu-icon">⚙️</span><span>Settings</span></a><a class="logout" href="logout.php"><span class="gp-menu-icon">↩️</span><span>Logout</span></a></div>
    <details class="gp-menu-section" open data-default-open="1"><summary>🐾 Dog</summary><div class="gp-menu-link-grid"><?php gpNavLink('handler_profile.php', '👤', 'Handler Profile'); ?><?php gpNavLink('dogs.php', '🐕', 'Dogs'); ?><?php gpNavLink('dog_profile.php', '🪪', 'Dog Profile'); ?><?php gpNavLink('qr_tracking.php', '📡', 'QR Tracking'); ?><?php gpNavLink('dog_access.php', '🤝', 'Dog Access'); ?><?php gpNavLink('dog_access_audit.php', '🧾', 'Dog Audit'); ?><?php gpNavLink('stats.php', '📊', 'Stats'); ?></div></details>
    <details class="gp-menu-section"><summary>📝 Logs</summary><div class="gp-menu-link-grid"><?php gpNavLink('quick_log.php', '⚡', 'Quick Session', 'quick_session_enabled'); ?><?php gpNavLink('log_entry.php', '📝', 'Detailed Log', 'detailed_log_enabled'); ?><?php gpNavLink('view_logs.php', '📋', 'History'); ?><?php gpNavLink('media_review.php', '🎥', 'Media Review', 'media_reviews_enabled'); ?><?php gpNavLink('video_review.php', '🎞️', 'Video Review', 'video_reviews_enabled'); ?></div></details>
    <details class="gp-menu-section"><summary>🎓 Training</summary><div class="gp-menu-link-grid"><?php gpNavLink('training_goal_intake.php', '🎯', 'Goal Intake', 'goal_intake_enabled'); ?><?php gpNavLink('habit_repair.php', '🛠️', 'Habit Repair', 'habit_repair_enabled'); ?><?php gpNavLink('candidate_assessment.php', '🐾', 'Candidate Assessment', 'candidate_scoring_enabled'); ?><?php gpNavLink('behavior_risk_scoring.php', '⚠️', 'Behavior Risk', 'behavior_risk_scoring_enabled'); ?><?php gpNavLink('regression_engine.php', '♻️', 'Regression Engine', 'regression_engine_enabled'); ?><?php gpNavLink('goal_builder.php', '🧩', 'Goal Builder', 'goal_builder_enabled'); ?><?php gpNavLink('coach_review.php', '🧭', 'Coach Review', 'coach_review_enabled'); ?><?php gpNavLink('training_program.php', '🎓', 'Training Program', 'training_program_enabled'); ?></div><details class="gp-menu-subgroup"><summary>More tools</summary><div class="gp-menu-link-grid"><?php gpNavLink('candidate_comparison.php', '🔎', 'Candidate Comparison', 'candidate_comparison_enabled'); ?><?php gpNavLink('community_challenges.php', '🏅', 'Community Challenges', 'community_challenges_enabled'); ?><?php gpNavLink('trucking_mode.php', '🚚', 'Trucking Mode', 'trucking_mode_enabled'); ?><?php gpNavLink('tactical_training.php', '🛡️', 'Tactical Training'); ?><?php gpNavLink('training_session_log.php', '✅', 'Session Log', 'training_progression_enabled'); ?><?php gpNavLink('training_history.php', '📚', 'Training History', 'training_progression_enabled'); ?></div></details></details>
    <details class="gp-menu-section"><summary>🩺 Care</summary><div class="gp-menu-link-grid"><?php gpNavLink('dog_health.php', '🩺', 'Health Docs', 'health_docs_enabled'); ?><?php gpNavLink('appointments.php', '📅', 'Vet Appointments', 'vet_appointments_enabled'); ?><?php gpNavLink('medications.php', '💊', 'Medications', 'medications_enabled'); ?><?php gpNavLink('wearable_integrations.php', '⌚', 'Wearable Sync', 'wearable_integrations_enabled'); ?></div></details>
    <details class="gp-menu-section"><summary>📢 Account</summary><div class="gp-menu-link-grid"><?php gpNavLink('notifications.php', '🔔', 'Notifications'); ?><?php gpNavLink('alerts.php', '🧠', 'Smart Alerts', 'alerts_enabled'); ?><?php gpNavLink('paywalls.php', '🏷️', 'Plans'); ?><?php gpNavLink('feedback.php', '💬', 'Feedback'); ?><?php gpNavLink('contact_us.php', '📇', 'Contact Us'); ?><?php gpNavLink('support_funding.php', '💙', 'Support GuidePaw'); ?></div></details>
    <details class="gp-menu-section"><summary>⚖️ Rights &amp; Resources</summary><div class="gp-menu-link-grid"><?php gpNavLink('ada_access_card.php', '🪪', 'ADA Access Card', 'ada_wallet_enabled'); ?><?php gpNavLink('service_dog_rights.php', '⚖️', 'ADA Quick Ref'); ?><?php gpNavLink('air_travel_rights.php', '✈️', 'Air Travel'); ?><?php gpNavLink('certification.php', '✅', 'Certification', 'certification_enabled'); ?><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Finder'); ?><?php gpNavLink('breed_gallery.php', '🐕', 'Breed Gallery', 'breed_photos_enabled'); ?><?php gpNavLink('trainer_marketplace.php', '🤝', 'Trainer Marketplace', 'trainer_marketplace_enabled'); ?><?php gpNavLink('ai_training_assistant.php', '🤖', 'AI Assistant', 'ai_training_assistant_enabled'); ?><?php gpNavLink('community.php', '🤝', 'Community'); ?></div></details>
    <?php if (gpNavIsAdmin()): ?>
    <details class="gp-menu-section"><summary>🛠️ Admin</summary><div class="gp-menu-link-grid"><?php gpNavLink('admin.php', '🛠️', 'Admin Home'); ?><?php gpNavLink('admin_users.php', '👥', 'Users'); ?><?php gpNavLink('admin_feedback.php', '💬', 'Feedback'); ?><?php gpNavLink('admin_feedback_ai.php', '🤖', 'AI Issues'); ?><?php gpNavLink('admin_found_dog_reports.php', '📍', 'Found Dogs'); ?><?php gpNavLink('admin_feature_roadmap.php', '🗺️', 'Roadmap'); ?><?php gpNavLink('admin_paywall_catalog.php', '🏷️', 'Paywalls'); ?><?php gpNavLink('admin_funding_settings.php', '💳', 'Funding'); ?><?php gpNavLink('admin_business_costs.php', '🧮', 'Costs'); ?><?php gpNavLink('admin_beta_requests.php', '📨', 'Beta Requests'); ?><?php gpNavLink('admin_tactical_requests.php', '🛡️', 'Tactical'); ?><?php gpNavLink('admin_notification_test.php', '🔔', 'Notif Test'); ?><?php gpNavLink('admin_profile_completion.php', '👤', 'Profiles'); ?><?php gpNavLink('api_tokens.php', '🔐', 'API Tokens'); ?><?php gpNavLink('db_status.php', '🩺', 'System Health'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'QA Checklist'); ?><?php gpNavLink('backup.php', '💾', 'Backups', 'backup_tools_enabled'); ?></div></details>
    <?php endif; ?>
</aside>
<script>(function(){var openBtn=document.getElementById('gpMenuOpen'),closeBtn=document.getElementById('gpMenuClose'),backdrop=document.getElementById('gpMenuBackdrop'),sections=Array.from(document.querySelectorAll('.gp-menu-section'));function openMenu(){document.body.classList.add('gp-menu-open');if(openBtn)openBtn.setAttribute('aria-expanded','true')}function closeMenu(){document.body.classList.remove('gp-menu-open');if(openBtn)openBtn.setAttribute('aria-expanded','false')}if(openBtn)openBtn.addEventListener('click',openMenu);if(closeBtn)closeBtn.addEventListener('click',closeMenu);if(backdrop)backdrop.addEventListener('click',closeMenu);document.addEventListener('keydown',function(event){if(event.key==='Escape')closeMenu();});sections.forEach(function(section){if(section.dataset.defaultOpen==='1'){section.open=true}})})();</script>
