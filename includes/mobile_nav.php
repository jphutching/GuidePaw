...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section" open data-default-open="1"><summary>⚡ Quick Actions</summary><div class="gp-menu-description">The most common handler actions, kept together so the dashboard can stay lighter.</div><div class="gp-menu-link-grid"><?php gpNavLink('quick_log.php', '⚡', 'Quick Session', 'quick_session_enabled'); ?><?php gpNavLink('log_entry.php', '📝', 'Detailed Log', 'detailed_log_enabled'); ?><?php gpNavLink('view_logs.php', '📋', 'History'); ?><?php gpNavLink('dog_health.php', '🩺', 'Health Docs', 'health_docs_enabled'); ?><?php gpNavLink('appointments.php', '📅', 'Vet Appointments', 'vet_appointments_enabled'); ?><?php gpNavLink('medications.php', '💊', 'Medications', 'medications_enabled'); ?><?php gpNavLink('alerts.php', '🧠', 'Smart Alerts', 'alerts_enabled'); ?><?php gpNavLink('stats.php', '📊', 'Stats'); ?><?php gpNavLink('air_travel_rights.php', '✈️', 'Air Travel Rights'); ?></div></details>
