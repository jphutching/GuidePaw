...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section"><summary>🪪 Access</summary><div class="gp-menu-description">Public-access references, ADA notes, flight rules, and certification tools.</div><div class="gp-menu-link-grid"><?php gpNavLink('ada_access_card.php', '🪪', 'ADA Access Card', 'ada_wallet_enabled'); ?><?php gpNavLink('service_dog_rights.php', '⚖️', 'Detailed ADA Notes'); ?><?php gpNavLink('air_travel_rights.php', '✈️', 'Air Travel Rights'); ?><?php gpNavLink('certification.php', '✅', 'Certification', 'certification_enabled'); ?></div></details>
    <details class="gp-menu-section"><summary>💬 Support</summary><div class="gp-menu-description">Send feedback, compare breed ideas, review beta testing notes, and find trainer contacts already in your account.</div><div class="gp-menu-link-grid"><?php gpNavLink('feedback.php', '💬', 'Feedback / Bug Report'); ?><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Questionnaire'); ?><?php gpNavLink('trainer_marketplace.php', '🤝', 'Trainer Marketplace', 'trainer_marketplace_enabled'); ?><?php gpNavLink('ai_training_assistant.php', '🤖', 'AI Training Assistant', 'ai_training_assistant_enabled'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'Beta QA Checklist'); ?></div></details>
