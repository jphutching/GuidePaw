...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section"><summary>💬 Support</summary><div class="gp-menu-description">Send feedback, compare breed ideas, and review beta testing notes.</div><div class="gp-menu-link-grid"><?php gpNavLink('feedback.php', '💬', 'Feedback / Bug Report'); ?><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Questionnaire'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'Beta QA Checklist'); ?></div></details>
