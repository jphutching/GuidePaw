...
<style>
    ...
    .gp-menu-root-actions { display:grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap:.6rem; margin-bottom:.85rem; }
...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section"><summary>🎓 Training</summary><div class="gp-menu-description">Plan, repair, assess, and track training progress.</div><div class="gp-menu-link-grid"><?php gpNavLink('training_program.php', '🎓', 'Training Program', 'training_program_enabled'); ?><?php gpNavLink('candidate_assessment.php', '🐾', 'Candidate Assessment', 'candidate_scoring_enabled'); ?><?php gpNavLink('candidate_comparison.php', '🔎', 'Candidate Comparison', 'candidate_comparison_enabled'); ?><?php gpNavLink('trucking_mode.php', '🚚', 'Trucking Mode', 'trucking_mode_enabled'); ?><?php gpNavLink('training_goal_intake.php', '🎯', 'Goal Intake', 'goal_intake_enabled'); ?><?php gpNavLink('habit_repair.php', '🛠️', 'Habit Repair', 'habit_repair_enabled'); ?><?php gpNavLink('training_session_log.php', '✅', 'Session Log', 'training_progression_enabled'); ?><?php gpNavLink('training_history.php', '📚', 'Training History', 'training_progression_enabled'); ?><?php gpNavLink('coach_review.php', '🧭', 'Coach Review', 'coach_review_enabled'); ?></div></details>
    <details class="gp-menu-section"><summary>🩺 Care</summary><div class="gp-menu-description">Health documents, appointments, medications, and active care alerts.</div><div class="gp-menu-link-grid"><?php gpNavLink('dog_health.php', '🩺', 'Health Docs', 'health_docs_enabled'); ?><?php gpNavLink('appointments.php', '📅', 'Vet Appointments', 'vet_appointments_enabled'); ?><?php gpNavLink('medications.php', '💊', 'Medications', 'medications_enabled'); ?></div></details>
    ...
    <details class="gp-menu-section"><summary>💬 Support</summary><div class="gp-menu-description">Send feedback, compare breed ideas, and review beta testing notes.</div><div class="gp-menu-link-grid"><?php gpNavLink('feedback.php', '💬', 'Feedback / Bug Report'); ?><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Questionnaire'); ?><?php gpNavLink('ai_training_assistant.php', '🤖', 'AI Training Assistant', 'ai_training_assistant_enabled'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'Beta QA Checklist'); ?></div></details>
