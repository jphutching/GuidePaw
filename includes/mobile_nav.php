...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section" open data-default-open="1"><summary>🐾 Dog</summary><div class="gp-menu-link-grid"><?php gpNavLink('index.php', '🏠', 'Dashboard'); ?><?php gpNavLink('handler_profile.php', '👤', 'Handler Profile'); ?><?php gpNavLink('dogs.php', '🐕', 'Dogs'); ?><?php gpNavLink('dog_profile.php', '🪪', 'Dog Profile'); ?><?php gpNavLink('qr_tracking.php', '📡', 'QR Tracking'); ?><?php gpNavLink('dog_access.php', '🤝', 'Dog Access'); ?><?php gpNavLink('dog_access_audit.php', '🧾', 'Dog Audit'); ?><?php gpNavLink('stats.php', '📊', 'Stats'); ?></div></details>
