...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section" open data-default-open="1"><summary>🐾 Dog</summary><div class="gp-menu-description">Manage the active dog, handler profile, dog details, and progress snapshot.</div><div class="gp-menu-link-grid"><?php gpNavLink('index.php', '🏠', 'Dashboard'); ?><?php gpNavLink('handler_profile.php', '👤', 'Handler Profile'); ?><?php gpNavLink('dogs.php', '🐕', 'Dogs'); ?><?php gpNavLink('dog_profile.php', '🪪', 'Dog Profile'); ?><?php gpNavLink('qr_tracking.php', '📡', 'QR Tracking'); ?><?php gpNavLink('dog_access.php', '🤝', 'Dog Access'); ?><?php gpNavLink('dog_access_audit.php', '🧾', 'Dog Audit'); ?><?php gpNavLink('stats.php', '📊', 'Stats'); ?></div></details>
    <details class="gp-menu-section"><summary>📝 Logs</summary><div class="gp-menu-description">Daily handler notes, sessions, media, and history.</div><div class="gp-menu-link-grid"><?php gpNavLink('quick_log.php', '⚡', 'Quick Session', 'quick_session_enabled'); ?><?php gpNavLink('log_entry.php', '📝', 'Detailed Log', 'detailed_log_enabled'); ?><?php gpNavLink('view_logs.php', '📋', 'History'); ?><?php gpNavLink('media_review.php', '🎥', 'Media Review', 'media_reviews_enabled'); ?><?php gpNavLink('video_review.php', '🎞️', 'Video Review', 'video_reviews_enabled'); ?></div></details>
    ...
    <details class="gp-menu-section"><summary>🩺 Care</summary><div class="gp-menu-description">Health documents, appointments, medications, and wearable syncs.</div><div class="gp-menu-link-grid"><?php gpNavLink('dog_health.php', '🩺', 'Health Docs', 'health_docs_enabled'); ?><?php gpNavLink('appointments.php', '📅', 'Vet Appointments', 'vet_appointments_enabled'); ?><?php gpNavLink('medications.php', '💊', 'Medications', 'medications_enabled'); ?><?php gpNavLink('wearable_integrations.php', '⌚', 'Wearable Sync', 'wearable_integrations_enabled'); ?></div></details>
    <details class="gp-menu-section"><summary>💬 More</summary><div class="gp-menu-description">Notifications, access, feedback, and the few extras handlers still need.</div><div class="gp-menu-link-grid"><?php gpNavLink('notifications.php', '🔔', 'Notification Center'); ?><?php gpNavLink('alerts.php', '🧠', 'Smart Alerts', 'alerts_enabled'); ?><?php gpNavLink('ada_access_card.php', '🪪', 'ADA Access Card', 'ada_wallet_enabled'); ?><?php gpNavLink('service_dog_rights.php', '⚖️', 'Detailed ADA Notes'); ?><?php gpNavLink('air_travel_rights.php', '✈️', 'Air Travel Rights'); ?><?php gpNavLink('certification.php', '✅', 'Certification', 'certification_enabled'); ?><?php gpNavLink('feedback.php', '💬', 'Feedback / Bug Report'); ?></div><details class="gp-menu-subgroup"><summary>Training extras</summary><div class="gp-menu-description">Optional tools for planning, comparisons, and coaching.</div><div class="gp-menu-link-grid"><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Questionnaire'); ?><?php gpNavLink('trainer_marketplace.php', '🤝', 'Trainer Marketplace', 'trainer_marketplace_enabled'); ?><?php gpNavLink('ai_training_assistant.php', '🤖', 'AI Training Assistant', 'ai_training_assistant_enabled'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'Beta QA Checklist'); ?></div></details><details class="gp-menu-subgroup"><summary>Admin tools</summary><div class="gp-menu-description">Admin pages stay hidden here unless you are signed in as an admin.</div><div class="gp-menu-link-grid"><?php if (gpNavIsAdmin()): ?><?php gpNavLink('admin.php', '🛠️', 'Admin Home'); ?><?php gpNavLink('admin_beta_requests.php', '📨', 'Beta Requests'); ?><?php gpNavLink('admin_found_dog_reports.php', '📍', 'Found Dog Reports'); ?><?php gpNavLink('admin_notification_test.php', '🔔', 'Notification Test'); ?><?php gpNavLink('admin_profile_completion.php', '👤', 'Profile Completion'); ?><?php gpNavLink('admin_feedback.php', '💬', 'Feedback Reports'); ?><?php gpNavLink('admin_users.php', '👥', 'User Management'); ?><?php gpNavLink('admin_feature_roadmap.php', '🗺️', 'Feature Roadmap'); ?><?php gpNavLink('api_tokens.php', '🔐', 'API Tokens'); ?><?php gpNavLink('db_status.php', '🩺', 'System Health'); ?><?php gpNavLink('backup.php', '💾', 'Backup Tools', 'backup_tools_enabled'); ?><?php endif; ?></div></details></details>
</aside>
