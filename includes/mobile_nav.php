...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section"><summary>🩺 Care</summary><div class="gp-menu-description">Health documents, appointments, medications, wearable syncs, and active care alerts.</div><div class="gp-menu-link-grid"><?php gpNavLink('dog_health.php', '🩺', 'Health Docs', 'health_docs_enabled'); ?><?php gpNavLink('appointments.php', '📅', 'Vet Appointments', 'vet_appointments_enabled'); ?><?php gpNavLink('medications.php', '💊', 'Medications', 'medications_enabled'); ?><?php gpNavLink('wearable_integrations.php', '⌚', 'Wearable Sync', 'wearable_integrations_enabled'); ?></div></details>
