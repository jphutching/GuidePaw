...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section"><summary>💬 More</summary><div class="gp-menu-link-grid"><?php gpNavLink('notifications.php', '🔔', 'Notification Center'); ?><?php gpNavLink('alerts.php', '🧠', 'Smart Alerts', 'alerts_enabled'); ?><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Finder'); ?><?php gpNavLink('community.php', '🤝', 'Community'); ?><?php gpNavLink('support_funding.php', '💙', 'Support Funding'); ?><?php gpNavLink('paywalls.php', '🏷️', 'Plans'); ?><?php gpNavLink('contact_us.php', '📇', 'Contact Us'); ?><?php gpNavLink('ada_access_card.php', '🪪', 'ADA Access Card', 'ada_wallet_enabled'); ?><?php gpNavLink('service_dog_rights.php', '⚖️', 'Detailed ADA Notes'); ?><?php gpNavLink('air_travel_rights.php', '✈️', 'Air Travel Rights'); ?><?php gpNavLink('certification.php', '✅', 'Certification', 'certification_enabled'); ?><?php gpNavLink('feedback.php', '💬', 'Feedback / Bug Report'); ?></div><details class="gp-menu-subgroup"><summary>Training extras</summary><div class="gp-menu-link-grid"><?php gpNavLink('trainer_marketplace.php', '🤝', 'Trainer Marketplace', 'trainer_marketplace_enabled'); ?><?php gpNavLink('ai_training_assistant.php', '🤖', 'AI Training Assistant', 'ai_training_assistant_enabled'); ?></div></details><details class="gp-menu-subgroup"><summary>Admin tools</summary><div class="gp-menu-link-grid"><?php if (gpNavIsAdmin()): ?><?php gpNavLink('admin.php', '🛠️', 'Admin Home'); ?><?php gpNavLink('admin_tactical_requests.php', '🛡️', 'Tactical Requests'); ?><?php gpNavLink('admin_beta_requests.php', '📨', 'Beta Requests'); ?><?php gpNavLink('admin_found_dog_reports.php', '📍', 'Found Dog Reports'); ?><?php gpNavLink('admin_notification_test.php', '🔔', 'Notification Test'); ?><?php gpNavLink('admin_profile_completion.php', '👤', 'Profile Completion'); ?><?php gpNavLink('admin_feedback.php', '💬', 'Feedback Reports'); ?><?php gpNavLink('admin_feedback_ai.php', '🤖', 'AI Issue Assistant'); ?><?php gpNavLink('admin_users.php', '👥', 'User Management'); ?><?php gpNavLink('admin_funding_settings.php', '💳', 'Funding Settings'); ?><?php gpNavLink('admin_business_costs.php', '🧮', 'Business Costs'); ?><?php gpNavLink('admin_feature_roadmap.php', '🗺️', 'Feature Roadmap'); ?><?php gpNavLink('admin_paywall_catalog.php', '🏷️', 'Paywall Catalog'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'Beta QA Checklist'); ?><?php gpNavLink('api_tokens.php', '🔐', 'API Tokens'); ?><?php gpNavLink('db_status.php', '🩺', 'System Health'); ?><?php gpNavLink('backup.php', '💾', 'Backup Tools', 'backup_tools_enabled'); ?><?php endif; ?></div></details></details>
</aside>
