...
<aside class="gp-menu-panel" id="gpAppMenu" aria-label="GuidePaw menu">
    ...
    <details class="gp-menu-section"><summary>💬 More</summary><div class="gp-menu-description">Notifications, access, feedback, and the few extras handlers still need.</div><div class="gp-menu-link-grid"><?php gpNavLink('notifications.php', '🔔', 'Notification Center'); ?><?php gpNavLink('alerts.php', '🧠', 'Smart Alerts', 'alerts_enabled'); ?><?php gpNavLink('ada_access_card.php', '🪪', 'ADA Access Card', 'ada_wallet_enabled'); ?><?php gpNavLink('service_dog_rights.php', '⚖️', 'Detailed ADA Notes'); ?><?php gpNavLink('air_travel_rights.php', '✈️', 'Air Travel Rights'); ?><?php gpNavLink('certification.php', '✅', 'Certification', 'certification_enabled'); ?><?php gpNavLink('feedback.php', '💬', 'Feedback / Bug Report'); ?></div><details class="gp-menu-subgroup"><summary>Advanced tools</summary><div class="gp-menu-description">Extra training tools and admin pages stay tucked away unless you need them.</div><div class="gp-menu-link-grid"><?php gpNavLink('breed_questionnaire.php', '❓', 'Breed Questionnaire'); ?><?php gpNavLink('trainer_marketplace.php', '🤝', 'Trainer Marketplace', 'trainer_marketplace_enabled'); ?><?php gpNavLink('ai_training_assistant.php', '🤖', 'AI Training Assistant', 'ai_training_assistant_enabled'); ?><?php gpNavLink('beta_qa_checklist.php', '✅', 'Beta QA Checklist'); ?><?php if (gpNavIsAdmin()): ?><?php gpNavLink('admin.php', '🛠️', 'Admin Home'); ?><?php gpNavLink('admin_beta_requests.php', '📨', 'Beta Requests'); ?><?php gpNavLink('admin_found_dog_reports.php', '📍', 'Found Dog Reports'); ?><?php gpNavLink('admin_notification_test.php', '🔔', 'Notification Test'); ?><?php gpNavLink('admin_profile_completion.php', '👤', 'Profile Completion'); ?><?php gpNavLink('admin_feedback.php', '💬', 'Feedback Reports'); ?><?php gpNavLink('admin_users.php', '👥', 'User Management'); ?><?php gpNavLink('admin_feature_roadmap.php', '🗺️', 'Feature Roadmap'); ?><?php gpNavLink('api_tokens.php', '🔐', 'API Tokens'); ?><?php gpNavLink('db_status.php', '🩺', 'System Health'); ?><?php gpNavLink('backup.php', '💾', 'Backup Tools', 'backup_tools_enabled'); ?><?php endif; ?></div></details></details>
</aside>
