...
- Files changed: feedback.php, scripts/local_qa_crawler.php, includes/beta_qa_checklist_items.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: no
- Next recommended step: keep working through the remaining open beta feedback rows; the feedback picker enhancement is live and beta row #30 is now fixed.

2026-05-09 — Alert suggestion link cleanup
- Commit(s): 78ed0c4 link alert module suggestions
- Files changed: index.php, scripts/local_qa_crawler.php, includes/beta_qa_checklist_items.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: no
- Next recommended step: rerun the crawler and confirm dashboard alert cards expose Start module links when the alert text points at a training module.
...
- New checklist items added: yes
- In-progress item changed: yes
- Next recommended step: keep the ADA card source label explicit, prefer GPS when permitted, fall back to the last retained state or the handler's home state, and keep the public QR profile limited to state-level context rather than exposing a full home address by default
...
2026-05-10 — Wearable connect flow simplification, bridge page, pair action, APK link, and Android companion scaffold
- Commit(s): pending
- Files changed: wearable_integrations.php, wearable_bridge.php, bridge_apk.php, includes/api_auth.php, includes/wearable_integrations.php, api/wearables.php, includes/beta_qa_checklist_items.php, scripts/local_qa_crawler.php, scripts/deploy_local.sh, android/guidepaw-bridge/, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: yes
- In-progress item changed: yes
- Next recommended step: verify the connect-code UI opens the bridge page and APK link on both local and beta, then keep Samsung Health / Health Connect syncing through the simplified wearable setup without the missing-include connect crash
...
2026-05-11 — Dashboard simplification pass
- Commit(s): pending
- Files changed: index.php, scripts/local_qa_crawler.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: yes
- Next recommended step: keep the home screen to the shortest useful path: sync, quick log, training, ADA, and the menu, with alerts living off the Today row

2026-05-11 — Menu simplification pass
- Commit(s): pending
- Files changed: includes/mobile_nav.php, scripts/local_qa_crawler.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: yes
- Next recommended step: keep the mobile menu to a small set of jobs, with Notifications, Access, Support, and Admin tucked under More instead of spread across separate sections

2026-05-11 — Home utility cleanup
- Commit(s): pending
- Files changed: index.php, scripts/local_qa_crawler.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: yes
...
2026-05-11 — Menu subgroup split
- Commit(s): pending
- Files changed: includes/mobile_nav.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: yes
...
2026-05-11 — Home dog shortcut removal
- Commit(s): pending
- Files changed: index.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: yes
...
2026-05-11 — Home menu hint repair
- Commit(s): pending
- Files changed: index.php, scripts/local_qa_crawler.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: yes
- In-progress item changed: yes
...
2026-05-11 — Home menu prompt removal
- Commit(s): pending
- Files changed: index.php, scripts/local_qa_crawler.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: no
- In-progress item changed: yes
...
2026-05-11 — AI issue assistant
- Commit(s): pending
- Files changed: admin_feedback_ai.php, includes/feedback_triage.php, admin_feedback.php, includes/mobile_nav.php, scripts/local_qa_crawler.php, tests/browser/guidepaw-admin-safe.spec.js, includes/beta_qa_checklist_items.php, GUIDEPAW_PROJECT_HISTORY.md
- New checklist items added: yes
- In-progress item changed: yes
