...
2026-05-10 — Wearable connect flow simplification
- Commit(s): pending
...
- New checklist items added: yes
- In-progress item changed: yes
- Next recommended step: verify the connect-code UI and bridge QR on both local and beta, then keep Samsung Health / Health Connect syncing through the simplified wearable setup
