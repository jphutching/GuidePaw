...
<div class="alert alert-info mb-3" role="note">
    <strong>Certification is not legally required.</strong>
    Under the ADA, service dog certifications, registrations, ID cards, and vests carry no legal weight and cannot be required for public access.
    Pursuing certifications equivalent to AKC Canine Good Citizen or program standards is encouraged as a training benchmark — but they do not create or expand legal rights.
    Always consult official sources (ada.gov) and applicable federal, state, and local law for the most current guidance.
</div>
...
</div><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script><?php guidepawFormUx(); ?>
</body></html>
