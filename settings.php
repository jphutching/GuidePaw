...
<main class="page-shell mt-3">
    ...
    <section class="card settings-card mb-3"><div class="card-body"><h2 class="h5 mb-1">Dog & App Shortcuts</h2><p class="settings-muted mb-3">These live in the menu now, but common shortcuts stay here for convenience.</p><a class="settings-link" href="dog_profile.php"><span><span class="settings-icon">🪪</span><?= $activeDog ? e($activeDog['name']) . ' profile' : 'Dog profile' ?></span><span>›</span></a><a class="settings-link" href="dogs.php"><span><span class="settings-icon">🐕</span>Manage dogs</span><span>›</span></a><a class="settings-link" href="feedback.php"><span><span class="settings-icon">💬</span>Feedback / bug report</span><span>›</span></a></div></section>
