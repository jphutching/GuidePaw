...
for url in \
  ...
  training_goal_intake.php goal_builder.php behavior_risk_scoring.php candidate_assessment.php candidate_comparison.php community_challenges.php habit_repair.php \
