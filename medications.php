...
<div class="page-shell"><div class="d-flex justify-content-between align-items-start gap-3 mb-3 flex-wrap"><div><div class="small-muted">Medication tracking</div><h1 class="h3 mb-1">💊 <?= e($dog['name']) ?></h1><div class="small-muted">Track dosing, refill dates, and reminder times per dog.</div></div><a href="index.php" class="btn btn-outline-secondary btn-sm">Dashboard</a></div><?php if(!empty($_GET['status'])): ?><div class="alert alert-success"><?= e(ucfirst($_GET['status'])) ?>.</div><?php endif; ?><?php if($errors): ?><div class="alert alert-danger"><ul class="mb-0"><?php foreach($errors as $error): ?><li><?= e($error) ?></li><?php endforeach; ?></ul></div><?php endif; ?>
